window.QUIZ_BANK = [
  ...
  },
  {
    ...
    "correct": 0,
    "explanation": "Route Reflector permite que um roteador reflita rotas BGP aprendidas de um cliente para outros clientes, reduzindo o número de sessões IBGP necessárias.",
    "difficulty": "Difícil"
  },
  {
  ...
  {
    "question": "Qual é a diferença entre 'PBR' (Policy Based Routing) e roteamento normal?",
    "options": [
      "PBR é mais rápido",
    ...
    "correct": 1,
    "explanation": "PBR permite decisões de roteamento baseadas em critérios além do IP de destino, como origem, aplicação ou marcação.",
    "difficulty": "Difícil"
  },
  {
  ...
  },
  {
    ...
    "options": [
      "Protocolo de roteamento",
      "Mecanismo rápido de detecção de falhas em links para acelerar convergência de protocolos de roteamento",
      "Tipo de ACL",
      "Método de NAT"
    ],
    "correct": 1,
    "explanation": "BFD fornece detecção de falhas em milissegundos, permitindo que protocolos de roteamento reajam muito mais rápido.",
    "difficulty": "Difícil"
  },
  {
