  ...
  "ccst": {
    "pt": [
      ...
      },
      {
        ...
        "options": [
          "PC a PC, ou switch a switch, sem Auto-MDIX",
          "PC a switch, ou router a switch (MDI a MDI-X)",
          "Apenas consolas Cisco",
          "Apenas fibra multimodo"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "O DHCP deixa de funcionar",
          "Terceiros na mesma BSS podem capturar tráfego não cifrado",
          "Os canais 1, 6 e 11 fecham",
          "O AP deixa de emitir beacon"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "O NAT deixa de traduzir",
          "Credenciais públicas permitem acesso de administração a quem chegar à rede",
          "O cabo Cat6 deixa de negociar Gigabit",
          "O DHCP só oferece APIPA"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "O destino está inalcançável na camada 3",
          "Há conectividade IP até 8.8.8.8, com RTT baixo e 0% de perda",
          "O DNS falhou",
          "O cabo está em half-duplex"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "O destino respondeu com sucesso",
          "Esse salto não devolveu ICMP Time Exceeded a tempo (filtro, perda ou sem resposta)",
          "O cabo está partido no PC",
          "O traceroute usa sempre TCP porta 80"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "O switch não tem tabela MAC",
          "O cabo é Cat6 em vez de Cat5e"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Mudar o spanning-tree para MST",
          "Ativar BGP"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Descarta sempre o frame",
          "Inunda (flood) o frame pelas portas da VLAN, exceto a de entrada",
          "Converte o frame em multicast 224.0.0.1",
          "Envia-o só ao default gateway"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Negociar EtherChannel",
          "Consultar o DNS e ver se um nome resolve para o IP esperado",
          "Cifrar o tráfego HTTPS",
          "Atribuir VLANs a portas"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Um cabo crossover para o switch",
          "Desativar o ARP"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Startup está sempre na flash do IOS",
          "Running só existe em switches, não em routers"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Só telefonia analógica",
          "10GBASE-T em até 100 m com melhor controlo de alien crosstalk",
          "Substituir sempre a fibra monomodo em WAN",
          "Alimentação PoE sem pares de dados"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Multicast all-routers",
          "O primeiro host de qualquer /24"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Cifrar ficheiros para resgate",
          "Esgotar recursos (CPU, largura de banda, sessões) para impedir o serviço legítimo",
          "Traduzir IPs privados em públicos",
          "Eleger o root bridge"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Todos usam enable secret partilhado",
          "Cada conta só tem as permissões necessárias à função",
          "Desativar sempre o firewall",
      ...
      },
      {
        ...
        "options": [
          "Sim, equivale a WPA3-Enterprise",
          "Não: o SSID ainda vai nos frames de dados e dá uma falsa sensação de segurança",
          "Sim, impede qualquer associação",
          "Só funciona em 6 GHz"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "UDP garante retransmissão obrigatória",
          "São transações curtas que não precisam de sessão fiável; menos overhead",
          "UDP cifra automaticamente",
          "TCP não pode usar a porta 53"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Cada camada remove o cabeçalho da camada inferior",
          "Cada camada adiciona o seu cabeçalho (e por vezes trailer) aos dados da camada superior",
          "Só a camada física adiciona cabeçalhos",
          "O switch remove o IP e o router remove o MAC sempre"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Desativar o ARP",
          "Mudar todos os MACs para FF:FF:FF:FF:FF:FF"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "10 Gb/s, porque só precisa de dois pares",
          "100 Mb/s (Fast Ethernet) possível; Gigabit precisa dos quatro pares",
          "Só fibra pode funcionar",
          "Nenhuma velocidade Ethernet funciona com pares abertos"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Falha só de certificado TLS no browser",
          "Problema de encaminhamento/WAN/firewall a montante do gateway local",
          "Cabo console desligado",
          "STP elegeu o PC como root"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Entrega no máximo 15,4 W como o 802.3af",
          "Permite potências mais altas (até cerca de 60 W / 90 W na PSE) para APs e câmaras exigentes",
          "Só funciona em fibra monomodo",
          "Substitui sempre a fonte externa mesmo sem negociação"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "O cabo Cat6 não suporta Fast Ethernet",
          "O SFP de fibra foi inserido na porta RJ-45"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Obrigatoriamente um endereço APIPA 169.254",
          "Desativar o NDP",
          "Trocar o MAC para ff:ff:ff:ff:ff:ff"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Sim, automaticamente via DFS",
          "Não: precisa de rádio e driver compatíveis com 6 GHz / 6E",
          "Sim, se o canal for 1, 6 ou 11",
          "Só se desativar o WPA3"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Maior penetração em paredes espessas que 2,4 GHz",
          "Mais espectro limpo e canais largos com menos redes legado a interferir",
          "Elimina a necessidade de autenticação",
          "Funciona sem antenas"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Associa com WEP automaticamente",
          "Não associa: 6 GHz exige WPA3 (SAE); o cliente tem de ser 6E e WPA3",
          "Associa se o canal for DFS",
          "Funciona só com IPv6"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Falta de rota estática no AP",
          "O cabo Cat6 não transporta PoE"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Aumentar só a potência do rádio Wi-Fi",
          "VLAN de dados no switch (e no telefone), cabo PC↔telefone, e se a porta está em access/trunk com voice VLAN correta",
          "Desativar Spanning Tree em todo o campus",
          "Mudar o hostname do router de borda"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Um WLC Cisco oficial que só serve SSIDs de convidados",
          "Um AP licenciado que usa sempre WPA3-Enterprise",
          "Um AP não autorizado ligado à rede cabeada (ou a emitir perto), que pode criar riscos de segurança e interferência",
          "Qualquer AP que use a banda de 2,4 GHz em vez de 5 GHz"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "O EAP-TLS só partilha um PSK para todo o SSID, como o WPA2-Personal clássico",
          "O PEAP exige certificado do cliente e o EAP-TLS nunca usa certificados",
          "Ambos desativam o RADIUS e autenticam só com a base de utilizadores local do AP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Substituir o CAPWAP por mesh proprietário só em 900 MHz",
          "Desativar permanentemente todos os clientes não-Wi-Fi sem um AP",
          "Detetar e classificar interferentes RF não-Wi-Fi (micro-ondas, Bluetooth, jammers) para o RRM/IT os mitigar",
          "Cifrar por omissão todos os frames de gestão com WEP"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Forçar todos os SSIDs a usar só a banda de 2,4 GHz",
          "Substituir o DHCP por endereços APIPA estáticos no roam",
          "Desligar a encriptação sempre que o cliente muda de AP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "O foreign termina o SSID de convidados localmente e nunca faz túnel; o anchor só guarda leases DHCP offline",
          "Ambos os controladores têm de estar no mesmo edifício e partilhar um IP de gestão, senão os convidados não associam",
          ...
          "O anchor só trata a banda de 2,4 GHz; o foreign só trata a de 5 GHz"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Encher a tabela CAM do switch com MACs falsos até o switch se comportar como hub; mitigar só com PortFast do spanning-tree",
          "Cifrar todas as mensagens DHCP Offer com WEP para os clientes não renovarem; mitigar desativando o DHCP relay",
          "Forçar todos os clientes a usar APIPA 169.254.x.x permanentemente; mitigar desligando o ARP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "O CDP só funciona em links de fibra; o LLDP só funciona em cobre",
          ...
          "O LLDP elege o DR OSPF; o CDP elege a root do STP",
          "Ambos os protocolos cifram toda a tabela de vizinhos com IPsec, por isso não se conseguem capturar num SPAN"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Cifrar cada trama Ethernet com IPsec entre dois PCs de acesso",
          "Substituir o Spanning Tree por uma única root bridge em todo o campus",
          ...
          "Forçar todas as portas de acesso para a mesma native VLAN do SVI de gestão"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Apenas o broadcast do SSID em cada beacon, tornando a rede num SSID oculto por omissão",
          "Todo o túnel CAPWAP entre AP e WLC com uma segunda camada IPsec",
          "Pacotes DHCP Offer no uplink com fio do AP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Forçar todos os clientes a fazer roam para 2,4 GHz sempre que o RSSI desça abaixo de −70 dBm",
          ...
          "Encriptar frames de gestão com AES-CCMP para que os beacons não possam ser falsificados",
          "Substituir CSMA/CA por um plano TDMA agendado em todos os APs"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "UPC é só para multimodo e APC só para monomodo; misturá-los funciona sempre do ponto de vista ótico",
          "O APC acrescenta uma férula metálica que duplica a potência de lançamento face ao UPC",
          "UPC e APC diferem apenas na cor do boot de alívio de tensão, com a mesma geometria da face",
      ...
      },
      {
        ...
        "options": [
          "Alimentar dispositivos apenas em portas SFP de fibra em vez de cobre RJ-45",
          "Substituir os pares de dados por condutores DC dedicados para que as tramas Ethernet já não partilhem o cabo",
          ...
          "Negociar adjacência de encaminhamento Layer 3 nos mesmos pares que transportam alimentação DC"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Forçar todos os clientes a um único spatial stream para o MU-MIMO nunca ser usado",
          "Substituir o WPA3 por um conjunto de cifras antigo baseado em WEP para endpoints IoT",
          "Estender a banda de 2,4 GHz a canais de 80 MHz idênticos ao VHT80 dos 5 GHz"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Encriptar todas as tramas na porta com MACsec para que switches não autorizados não formem EtherChannel",
          ...
          "Substituir o STP por uma blacklist de aprendizagem MAC que desativa permanentemente as VLANs no uplink",
          "Forçar a porta a operar apenas como interface Layer 3 com máscara /30"
        ],
        "correct": 1,
    ...
    "en": [
      ...
      },
      {
        ...
        "options": [
          "The UTP cable only has 2 pairs connected",
          "A switch/hub (or a PC bridging) sent BPDUs on an access port with BPDU Guard enabled",
          "PoE exceeds the PSU budget",
          "The client is missing DNS"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "The AP is missing a static route",
          "Cat6 cable cannot carry PoE"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Complete Layer 1 failure on the AP",
          "DNS or captive-portal HTTP redirect/name resolution issue — not basic IP forwarding",
          "The switch lost every native VLAN",
          "The core cable is stuck at 10 Mbps"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Deletes all VLANs and forces every switch into Client mode",
          "Only advertises VLANs learned from RADIUS",
          "Forwards VTP advertisements but does not update its own VLAN database from them",
          "Encrypts all VLAN trunks with MACsec automatically"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Always the switch with the highest port count",
          "The first switch that boots in the VLAN",
          "Only a multilayer router can be root"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Encrypting management sessions end-to-end like SSH",
          "Replacing OSPF as the interior routing protocol",
          "Authenticating wireless clients with certificates",
      ...
      },
      {
        ...
        "options": [
          "It turns the router into a DHCP server that invents leases locally",
          "DHCP relay: it forwards DHCP broadcasts from clients as unicast to a remote DHCP server",
          "It disables all broadcasts on that VLAN permanently",
          "It only translates IPv6 Neighbor Discovery to IPv4 ARP"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "An official Cisco WLC that only serves guest SSIDs",
          "A licensed AP that always uses WPA3-Enterprise",
          ...
          "Any AP that uses the 2.4 GHz band instead of 5 GHz"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "EAP-TLS only shares one PSK for the whole SSID, like classic WPA2-Personal",
          "PEAP requires a client certificate while EAP-TLS never uses certificates",
          "Both methods disable RADIUS and authenticate only with the AP’s local user database"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Replace CAPWAP with proprietary mesh only on 900 MHz",
          "Disable all non-Wi-Fi clients permanently without an AP",
          "Detect and classify non-Wi-Fi RF interferers (microwaves, Bluetooth, rogue jammers) so RRM/IT can mitigate them",
          "Encrypt every management frame with WEP by default"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Force every SSID to use only the 2.4 GHz band",
          "Replace DHCP with static APIPA addresses on roam",
          "Turn off encryption whenever the client changes AP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "The foreign controller terminates the guest SSID locally and never tunnels anything; the anchor only stores DHCP leases offline",
          "Both controllers must be in the same building and share one management IP, or guests cannot associate",
          ...
          "The anchor controller only handles 2.4 GHz; the foreign controller only handles 5 GHz"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Flood the switch CAM table with fake MACs until the switch acts like a hub; mitigate only with spanning-tree PortFast",
          "Encrypt all DHCP Offer messages with WEP so clients cannot renew; mitigate by disabling DHCP relay",
          "Force every client to use APIPA 169.254.x.x permanently; mitigate by turning off ARP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "CDP works only on fiber links; LLDP works only on copper",
          ...
          "LLDP elects the OSPF DR; CDP elects the STP root",
          "Both protocols encrypt the entire neighbor table with IPsec, so they cannot be captured on a span port"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Encrypting every Ethernet frame with IPsec between two access PCs",
          "Replacing Spanning Tree with a single root bridge for the whole campus",
          ...
          "Forcing all access ports into the same native VLAN as the management SVI"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Only the SSID broadcast in every beacon, turning the network into a hidden SSID by default",
          "The entire CAPWAP tunnel between AP and WLC with a second IPsec layer",
          "DHCP Offer packets on the wired uplink of the AP"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Forcing every client to roam to 2.4 GHz whenever RSSI drops below −70 dBm",
          ...
          "Encrypting management frames with AES-CCMP so beacons cannot be spoofed",
          "Replacing CSMA/CA with a scheduled TDMA airtime plan on every AP"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "UPC is only for multimode and APC is only for single-mode; mixing them always works optically",
          "APC adds a metal ferrule that doubles the launch power compared with UPC",
          "UPC and APC differ only in the color of the strain-relief boot, with identical end-face geometry",
      ...
      },
      {
        ...
        "options": [
          "Only powering devices over fiber SFP ports instead of copper RJ-45",
          "Replacing the data pairs with dedicated DC conductors so Ethernet frames no longer share the cable",
          ...
          "Negotiating Layer 3 routing adjacency over the same pairs that carry DC power"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Forcing every client onto a single spatial stream so MU-MIMO is never used",
          "Replacing WPA3 with an older WEP-based cipher suite for IoT endpoints",
          "Extending the 2.4 GHz band to 80 MHz-wide channels identical to 5 GHz VHT80"
        ],
        "correct": 0,
  ...
  "ccna": {
    "pt": [
      ...
      },
      {
        ...
        "options": [
          "Maior prioridade numerica",
          "Menor Bridge ID (prioridade + MAC)",
          "Maior numero de VLANs",
          "Maior uptime"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Um IP publico por cada privado, 1:1",
      ...
      },
      {
        ...
        "options": [
          "Apenas os bits CoS 802.1Q (sobrevivem inalterados em cada hop routed)",
      ...
      },
      {
        ...
        "options": [
          "IPFIX é só uma extensão CDP de Camada 2 e não exporta flows",
          ...
          "IPFIX substitui LSAs OSPF por registos de flow",
          "IPFIX desativa o CEF para process-switching de todos os pacotes"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Rota estática que ganha sempre ao OSPF porque o AD estático é infinito",
          "Rota que faz load-balance igual com todos os protocolos dinâmicos por omissão",
          "Host route que só pode apontar para uma interface null0"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Sempre o router com o process ID OSPF mais baixo",
          "Só o router que tem uma default route estática",
          "Ganha a maior prioridade de interface OSPF; em empate, o Router ID mais alto (o BDR é o seguinte)",
          "Round-robin entre todos os vizinhos a cada intervalo Hello"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Idle — o BGP desativou permanentemente o vizinho",
          "Active — o BGP só escuta e nunca envia mensagens Open",
      ...
      },
      {
        ...
        "options": [
          "Encriptar o Neighbor Discovery com IPsec por omissão em todas as LANs",
          "Verificar que nenhum outro nó no link já usa o endereço candidato, enviando um Neighbor Solicitation para esse endereço",
          "Pedir um prefixo global exclusivamente a um servidor DHCPv6 e ignorar Router Advertisements",
          "Converter todos os endereços link-local em anycast públicos na Internet"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Para cifrar por omissão as mensagens BGP UPDATE com IPsec",
          "Para forçar o vizinho permanentemente para o estado Idle",
          "Para substituir métricas OSPF por hop count dentro da LAN",
      ...
      },
      {
        ...
        "options": [
          "Que o MAC de destino é igual ao BIA do router antes do hello OSPF",
          ...
          "Que todos os pacotes têm marcação DSCP EF",
          "Que os peers BGP estão em Established antes de encaminhar qualquer tráfego LAN"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Para substituir a tabela MAC de cada router por LSAs OSPF",
          "Para forçar o BGP a usar só a distância administrativa por omissão do RIP",
          "Para cifrar automaticamente todas as atualizações de routing com IPsec sempre que dois IGPs se encontram",
      ...
      },
      {
        ...
        "options": [
          "Usar mais do que um caminho de custo igual ao mesmo tempo (ECMP)",
          "Anunciar uma rota de volta pela mesma interface pela qual foi aprendida, o que ajuda a limitar loops de routing simples",
          "Enviar quaisquer pacotes Hello em segmentos broadcast",
          "Aprender rotas por omissão via DHCP em interfaces LAN"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          ...
          "Se o EtherChannel negoceia exclusivamente com LACP ou com PAgP",
          "A prioridade de root bridge STP de todas as VLANs no canal",
          "O ID da VLAN nativa que tem de ser usada em todas as portas membro"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "A Reported Distance é sempre igual à largura de banda da interface em kb/s; a Feasible Distance só é usada pelo OSPF",
          "Um feasible successor é qualquer vizinho que anuncia métrica infinita (poison reverse)",
          ...
          "A Feasible Distance é o hop count do RIP; a Reported Distance é o valor MED do BGP copiado para o EIGRP"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "O tunnel mode só funciona com AH; o transport mode só funciona com ESP",
          "O transport mode cifra todo o pacote IP original incluindo o cabeçalho exterior usado para o encaminhamento na Internet",
          "Ambos os modos acrescentam sempre um cabeçalho GRE extra antes do ESP",
      ...
      },
      {
        ...
        "options": [
          "Forçar todos os clientes apenas para a banda de 6 GHz, mesmo que o cliente seja 802.11n",
          ...
          "Substituir o CAPWAP por uma bridge Ethernet de Camada 2 entre AP e WLC",
          "Desativar OFDM em 5 GHz para que só clientes DSSS se associem"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "ICMP Echo Request periódicos com exatamente 1500 bytes a partir de cada hop de router",
          "O TCP anunciar sempre uma window de 536 bytes para nunca ser necessária fragmentação",
          ...
          "Forçar todas as interfaces de túnel a fazer clamp do TCP MSS para 40 bytes abaixo do MTU físico"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Porque o OSPF recusa eleger Designated Router fora da Area 0 em qualquer segmento multi-acesso",
          "Porque a Area 0 é o único sítio onde são permitidas chaves de autenticação OSPF",
          "Porque as LSA Type 1 (Router) só são inundadas dentro da Area 0 e nunca noutras áreas",
      ...
      },
      {
        ...
        "options": [
          "Ambos encaminham tráfego de utilizador em ECMP active-active, partilhando sempre o mesmo MAC virtual em igualdade",
          ...
          "O Standby faz sempre NAT dos endereços dos clientes enquanto o Active só responde a ARP",
          "O HSRP elege um Designated Router e um Backup Designated Router exatamente como o OSPF numa LAN"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Encriptar os payloads spoke-to-spoke com um perfil IPsec separado que substitui completamente o IKEv2",
          "Anunciar tabelas BGP completas da Internet a partir de cada spoke para o hub para os spokes nunca precisarem de túnel",
          "Atuar como IGP do underlay que substitui OSPF ou EIGRP nas interfaces WAN físicas",
    ...
    "en": [
      ...
      },
      {
        ...
        "correct": 3,
        "explanation": "DSCP (Differentiated Services Code Point) in the IP header marks packets for QoS across routed networks. 802.1Q CoS (PCP) is a Layer-2 trunk marking and is not preserved once the frame is routed.",
        "difficulty": "Medium"
      },
      {
    ...
    "pt": [
      ...
      },
      {
        ...
        "options": [
          ...
          "Confiar automaticamente em qualquer host dentro do perímetro do firewall",
          "Desativar 802.1X e usar só hubs",
          "Substituir BGP por rotas estáticas em todo o core"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Calcular o melhor caminho BGP com AS-path",
          "Substituir OSPF no core do campus",
          "Ajustar dinamicamente canais/potência (e relacionados) dos APs para reduzir interferência e melhorar RF",
          "Cifrar o plano de controlo com MACsec entre routers WAN"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Só a configurar EtherChannel LACP",
          "Eliminar a necessidade de syslog",
          "Desativar CoPP no control plane",
      ...
      },
      {
        ...
        "options": [
          ...
          "Encriptar o plano de controlo com IPsec por omissão",
          "Substituir completamente a amostragem NetFlow",
          "Desativar o STP na VLAN monitorizada"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Obriga todos os frames do utilizador a voltar ao WLC antes de chegar à LAN local",
          "Desativa todos os SSIDs quando o túnel CAPWAP cai",
          "Faz bridge do tráfego de cliente para a VLAN wired local no AP (quando configurado), mesmo com caminho ao WLC limitado",
          "Converte o AP num route reflector BGP completo"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Bloqueia para sempre todo o tráfego IPv6 exceto DHCPv6",
          "Filtra Router Advertisements rogue nas portas de acesso para só portas trusted poderem anunciar prefixos/gateways",
          "Substitui o SLAAC por endereçamento estático obrigatório em todos os hosts",
          "Encripta automaticamente o Neighbor Discovery com IPsec"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "É o único que reencaminha todos os pacotes de dados do utilizador no underlay",
          "Substitui todos os routers de edge WAN por bridges de Camada 2",
          "Só guarda registos NetFlow para compliance",
      ...
      },
      {
        ...
        "options": [
          ...
          "O switch spine físico que substitui o cluster de controladores APIC",
          "Uma community BGP que o ACI copia sem alterações para todos os WAN edges",
          "Um template de sampler NetFlow guardado só no border leaf"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Inundam sempre todo o tráfego no underlay sem filtros assim que partilham o nome do tenant",
          "Só se ambos os EPGs forem configurados como vizinhos OSPF no mesmo loopback",
          ...
          "Ativando Root Guard PVST+ clássico em todos os downlinks dos leafs"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Terminar todas as sessões BGP só com peers SPINE externos",
          "Substituir o cluster APIC por um único leaf switch",
          "Cifrar contracts com WPA3-Personal"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Uma substituição da TCAM de hardware em todos os switches Catalyst",
          "Um SSID wireless que desativa permanentemente o 802.1X",
          ...
          "Uma community BGP que define sempre Local Preference a 0"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Substituir o IGP do underlay por um protocolo de routing proprietário só em Python em todos os PE",
          "Como o único GUI suportado para configurar contracts ACI dentro do APIC",
          "Como substituto do RADIUS na autenticação 802.1X em wireless"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Apenas se a porta do switch está em err-disable por causa do BPDU Guard",
          "Apenas o area ID OSPF configurado no portátil do utilizador",
          ...
          "Se o nome do SSID está escondido, o que por si só prova que o cliente é de confiança"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Termina todo o DHCP e NAT de utilizadores de cada edge switch apenas em hardware",
          ...
          "Substitui o Spanning Tree inundando cada MAC desconhecido para todo o underlay",
          "É apenas uma GUI de gestão e nunca participa no data nem no control plane"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Todas as interfaces têm de estar na VLAN 1, e as ACLs nas linhas VTY filtram o tráfego de trânsito",
          "O ZBFW só inspeciona joins PIM multicast e ignora unicast TCP/UDP",
          "Configura-se só ip inspect CBAC globalmente; as zones são ignoradas quando o NAT está ativo",
      ...
      },
      {
        ...
        "options": [
          "Substituir permanentemente o TACACS+ pelo RADIUS em todos os logins CLI dos equipamentos",
          "Descarregar a imagem IOS do switch por TFTP após cada sessão 802.1X bem-sucedida",
          ...
          "Eleger a root bridge do STP com base no shared secret do RADIUS"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          ...
          "Substituir o BGP por um IGP underlay proprietário só Cisco no core da Internet",
          "Fornecer Power over Ethernet a servidores numa fabric leaf-spine",
          "Cifrar consultas DNS entre resolvers recursivos e servidores autoritativos"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Converter automaticamente todas as sessões eBGP em iBGP para remover o número de AS",
          ...
          "Forçar cada peer a limpar toda a tabela BGP e reconvergir do zero por consistência",
          "Substituir o keepalive TCP por deteção só com BFD e apagar todos os labels MPLS"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Servir de default gateway e fronteira NAT de todas as VLANs de acesso no campus",
          "Terminar todos os túneis IPsec site-to-site para os sensores de ameaças nunca verem tráfego encriptado",
          "Substituir o ISE na autenticação 802.1X das portas de acesso dos switches",
      ...
      },
      {
        ...
        "options": [
          ...
          "O VTEP é apenas um endereço de grupo multicast, e o VNI é o process ID OSPF do underlay",
          "O VNI é o número de série físico do switch, e o VTEP é um shared secret RADIUS",
          "Ambos os termos significam a mesma coisa: a porta UDP de destino exterior 4789"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "vManage = ASIC de encaminhamento data-plane; vSmart = servidor DHCP; vBond = wireless controller",
          "vManage = só IGP do underlay; vSmart = gateway NAT; vBond = coletor syslog",
          ...
          "Os três appliances encaminham pacotes de utilizador no data plane e nunca participam no controlo ou na gestão"
        ],
        "correct": 2,
    ...
    "pt": [
      {
        ...
        "options": [
          "Garantir que os sistemas estão sempre disponíveis para utilizadores autorizados",
          "Garantir que só entidades autorizadas acedem à informação, tipicamente com controlos de acesso e encriptação",
          "Garantir que os dados não são alterados sem deteção, por exemplo com hashes e assinaturas",
          "Garantir que o tráfego de rede usa sempre a porta 443"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Um firewall só analisa malware em anexos de email; IDS/IPS só faz NAT",
          "Firewall e IDS são a mesma coisa; IPS é apenas a marca comercial Cisco",
          ...
          "O IDS substitui completamente AAA (Authentication, Authorization, Accounting)"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Apenas encriptação de ligações VPN site-to-site",
          "Apenas balanceamento de carga entre controladores wireless",
          "Apenas inventário automático de switches na LAN",
      ...
      },
      {
        ...
        "options": [
          ...
          "IPsec só funciona em IPv6; SSL VPN só em IPv4",
          "SSL VPN substitui sempre o routing OSPF no núcleo",
          "IPsec e SSL VPN são exatamente o mesmo protocolo com nomes diferentes"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          ...
          "Um protocolo Cisco para sincronizar relógios NTP",
          "Uma ACL que permite apenas HTTPS",
          "Um tipo de cabo de fibra óptica multimodo"
        ],
        "correct": 0,
      ...
      },
      {
        ...
        "options": [
          "Confiar automaticamente em qualquer dispositivo dentro da LAN corporativa",
          "Desligar todos os firewalls porque a cloud já é segura",
          ...
          "Usar apenas passwords partilhadas em switches de acesso"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "O ISE substitui completamente o routing BGP na Internet",
          ...
          "SecureX é apenas um cabo consola; ISE é só um tema de wallpaper",
          "Ambos servem exclusivamente para configurar VLANs em switches não geridos"
        ],
        "correct": 1,
      ...
      },
      {
        ...
        "options": [
          "Hashing e encriptação são sempre o mesmo algoritmo AES",
          "A encriptação só funciona em texto português; hashing só em inglês",
          "Hashing aumenta o tamanho dos dados; encriptação reduz sempre para 128 bits",
      ...
      },
      {
        ...
        "options": [
          "Porque elimina a necessidade de patches de segurança no sistema operativo",
          "Porque torna o Wi-Fi automaticamente WPA3 sem configuração",
          "Porque substitui firewalls perimetrais em todos os cenários",
      ...
      },
      {
        ...
        "options": [
          "Usar uma única password complexa para todos os dispositivos",
          "Confiar apenas num antivirus no endpoint e remover a segmentação",
          "Aplicar várias camadas de controlos (perímetro, rede, identidade, endpoint, dados) para que a falha de um não comprometa tudo",
          "Desativar logs para melhorar a performance"
        ],
        "correct": 2,
      ...
      },
      {
        ...
        "options": [
          "Aumentar o broadcast domain para que o malware se propague mais depressa",
          "Eliminar a necessidade de atualizar firmware",
          "Permitir que convidados usem a mesma VLAN de gestão dos routers",
